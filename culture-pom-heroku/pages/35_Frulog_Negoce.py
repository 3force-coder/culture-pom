...
st.set_page_config(page_title="Frulog Négoce - POMI", page_icon="🏪", layout="wide")
st.markdown("""<style>
...
def render_analyse_ventes(data, data_prev, label_prev, label):
    ...
    if vue == "📊 Vue d'ensemble":
        ...
        st.download_button("📥 Export clients", buf.getvalue(), "clients_negoce.xlsx", use_container_width=True)
